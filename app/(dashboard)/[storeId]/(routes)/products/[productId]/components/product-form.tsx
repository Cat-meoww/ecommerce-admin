...
interface MyProduct extends Omit<Product, 'price'> {
    price: string;
    images: Image[];
}

interface ComponentProps {
    initialData: MyProduct | null;
    categories: Category[];
    colors: Color[];
    sizes: Size[];
}
...
export const ProductForm: React.FC<ComponentProps> = ({
    initialData,
    categories,
    colors,
    sizes }) => {
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <ImageUpload
                                    ...
                                    disabled={loading}
                                    onChange={(urls) => {
                                        field.onChange([...field.value, ...urls.map(url => ({ url }))])
                                    }}
                                    onRemove={url =>
                                        field.onChange([
