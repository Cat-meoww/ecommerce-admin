  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center p-8 rounded-lg min-h-[10rem] bg-opacity-80">
        <div className="animate-spin rounded-full border-2 border-current border-t-transparent h-4 w-4 text-neutral-500" />
      </div>
    )
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-2">
        ...
        <div>
          <Button disabled={draggedInside} type='button' onClick={handleUploadClick} variant="ghost" size="sm">
            <UploadIcon size={16} />
            Upload an image
          </Button>
        </div>
